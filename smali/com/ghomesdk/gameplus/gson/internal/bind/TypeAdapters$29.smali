.class final Lcom/ghomesdk/gameplus/gson/internal/bind/TypeAdapters$29;
...
# virtual methods
.method public read(Lcom/ghomesdk/gameplus/gson/stream/JsonReader;)Lcom/ghomesdk/gameplus/gson/JsonElement;
    .locals 3
    ...
    .line 700
    sget-object v0, Lcom/ghomesdk/gameplus/gson/internal/bind/TypeAdapters$36;->$SwitchMap$com$ghomesdk$gameplus$gson$stream$JsonToken:[I
    ...
    invoke-virtual {p0, p1}, Lcom/ghomesdk/gameplus/gson/internal/bind/TypeAdapters$29;->read(Lcom/ghomesdk/gameplus/gson/stream/JsonReader;)Lcom/ghomesdk/gameplus/gson/JsonElement;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Lcom/ghomesdk/gameplus/gson/JsonObject;->add(Ljava/lang/String;Lcom/ghomesdk/gameplus/gson/JsonElement;)V
    ...
    invoke-virtual {v0, v1}, Lcom/ghomesdk/gameplus/gson/JsonArray;->add(Lcom/ghomesdk/gameplus/gson/JsonElement;)V
    ...
    new-instance v1, Lcom/ghomesdk/gameplus/gson/internal/LazilyParsedNumber;

    invoke-direct {v1, p1}, Lcom/ghomesdk/gameplus/gson/internal/LazilyParsedNumber;-><init>(Ljava/lang/String;)V

    invoke-direct {v0, v1}, Lcom/ghomesdk/gameplus/gson/JsonPrimitive;-><init>(Ljava/lang/Number;)V
...
.method public write(Lcom/ghomesdk/gameplus/gson/stream/JsonWriter;Lcom/ghomesdk/gameplus/gson/JsonElement;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 737
    invoke-virtual {p2}, Lcom/ghomesdk/gameplus/gson/JsonElement;->isJsonNull()Z
    ...
    .line 739
    :cond_0
    invoke-virtual {p2}, Lcom/ghomesdk/gameplus/gson/JsonElement;->isJsonPrimitive()Z
    ...
    .line 740
    invoke-virtual {p2}, Lcom/ghomesdk/gameplus/gson/JsonElement;->getAsJsonPrimitive()Lcom/ghomesdk/gameplus/gson/JsonPrimitive;

    move-result-object p2

    .line 741
    invoke-virtual {p2}, Lcom/ghomesdk/gameplus/gson/JsonPrimitive;->isNumber()Z
    ...
    .line 742
    invoke-virtual {p2}, Lcom/ghomesdk/gameplus/gson/JsonPrimitive;->getAsNumber()Ljava/lang/Number;
    ...
    .line 743
    :cond_1
    invoke-virtual {p2}, Lcom/ghomesdk/gameplus/gson/JsonPrimitive;->isBoolean()Z
    ...
    .line 744
    invoke-virtual {p2}, Lcom/ghomesdk/gameplus/gson/JsonPrimitive;->getAsBoolean()Z
    ...
    .line 746
    :cond_2
    invoke-virtual {p2}, Lcom/ghomesdk/gameplus/gson/JsonPrimitive;->getAsString()Ljava/lang/String;
    ...
    .line 749
    :cond_3
    invoke-virtual {p2}, Lcom/ghomesdk/gameplus/gson/JsonElement;->isJsonArray()Z
    ...
    .line 751
    invoke-virtual {p2}, Lcom/ghomesdk/gameplus/gson/JsonElement;->getAsJsonArray()Lcom/ghomesdk/gameplus/gson/JsonArray;

    move-result-object p2

    invoke-virtual {p2}, Lcom/ghomesdk/gameplus/gson/JsonArray;->iterator()Ljava/util/Iterator;
    ...
    .line 752
    invoke-virtual {p0, p1, v0}, Lcom/ghomesdk/gameplus/gson/internal/bind/TypeAdapters$29;->write(Lcom/ghomesdk/gameplus/gson/stream/JsonWriter;Lcom/ghomesdk/gameplus/gson/JsonElement;)V
    ...
    .line 756
    :cond_5
    invoke-virtual {p2}, Lcom/ghomesdk/gameplus/gson/JsonElement;->isJsonObject()Z
    ...
    .line 758
    invoke-virtual {p2}, Lcom/ghomesdk/gameplus/gson/JsonElement;->getAsJsonObject()Lcom/ghomesdk/gameplus/gson/JsonObject;

    move-result-object p2

    invoke-virtual {p2}, Lcom/ghomesdk/gameplus/gson/JsonObject;->entrySet()Ljava/util/Set;
...
.method public bridge synthetic write(Lcom/ghomesdk/gameplus/gson/stream/JsonWriter;Ljava/lang/Object;)V
    ...
    .line 698
    check-cast p2, Lcom/ghomesdk/gameplus/gson/JsonElement;

    invoke-virtual {p0, p1, p2}, Lcom/ghomesdk/gameplus/gson/internal/bind/TypeAdapters$29;->write(Lcom/ghomesdk/gameplus/gson/stream/JsonWriter;Lcom/ghomesdk/gameplus/gson/JsonElement;)V
