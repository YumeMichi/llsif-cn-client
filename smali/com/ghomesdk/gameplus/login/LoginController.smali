...
.method private getPage(IILjava/util/Map;)Lcom/ghomesdk/gameplus/login/ui/LoginView;
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "Ljava/lang/String;",
            ">;)",
            "Lcom/ghomesdk/gameplus/login/ui/LoginView;"
        }
    .end annotation
    ...
    .line 499
    new-instance p1, Lcom/ghomesdk/gameplus/login/ui/PwdLoginView;

    iget-object p2, p0, Lcom/ghomesdk/gameplus/login/LoginController;->dispatcher:Lcom/ghomesdk/gameplus/login/LoginDispatcher;

    invoke-virtual {p2}, Lcom/ghomesdk/gameplus/login/LoginDispatcher;->getLoginContext()Lcom/ghomesdk/gameplus/login/LoginContext;

    move-result-object p2

    iget-object p2, p2, Lcom/ghomesdk/gameplus/login/LoginContext;->inputPhoneStr:Ljava/lang/String;

    invoke-direct {p1, p2}, Lcom/ghomesdk/gameplus/login/ui/PwdLoginView;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {p2}, Lcom/ghomesdk/gameplus/login/LoginDispatcher;->isGuestProcess()Z
    ...
    .line 511
    :cond_1
    new-instance p2, Lcom/ghomesdk/gameplus/login/ui/SmsLoginView;

    iget-object p3, p0, Lcom/ghomesdk/gameplus/login/LoginController;->dispatcher:Lcom/ghomesdk/gameplus/login/LoginDispatcher;

    invoke-virtual {p3}, Lcom/ghomesdk/gameplus/login/LoginDispatcher;->getLoginContext()Lcom/ghomesdk/gameplus/login/LoginContext;

    move-result-object p3

    iget-object p3, p3, Lcom/ghomesdk/gameplus/login/LoginContext;->inputPhoneStr:Ljava/lang/String;

    invoke-direct {p2, p1, p3}, Lcom/ghomesdk/gameplus/login/ui/SmsLoginView;-><init>(ZLjava/lang/String;)V
    ...
    .line 513
    new-instance p1, Lcom/ghomesdk/gameplus/login/ui/SmallAccountLoginView;

    invoke-direct {p1}, Lcom/ghomesdk/gameplus/login/ui/SmallAccountLoginView;-><init>()V
    ...
    .line 515
    new-instance p1, Lcom/ghomesdk/gameplus/login/ui/ResetPasswordInputViewNew;
    ...
    const-string p3, "\u91cd\u7f6e\u5bc6\u7801"

    invoke-direct {p1, p2, p3}, Lcom/ghomesdk/gameplus/login/ui/ResetPasswordInputViewNew;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 518
    new-instance p2, Lcom/ghomesdk/gameplus/login/ui/SetPasswordInputView;

    const-string p3, "\u8bbe\u7f6e\u5bc6\u7801"

    invoke-direct {p2, p1, p3}, Lcom/ghomesdk/gameplus/login/ui/SetPasswordInputView;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v0, "realInfoNotification"
    ...
    .line 523
    new-instance v0, Lcom/ghomesdk/gameplus/login/ui/FillRealInfoView;
    ...
    invoke-direct {v0, p1, p2, v1, p3}, Lcom/ghomesdk/gameplus/login/ui/FillRealInfoView;-><init>(ZZZLjava/lang/String;)V
    ...
    .line 526
    new-instance p2, Lcom/ghomesdk/gameplus/login/ui/FillRealInfoView;
    ...
    invoke-direct {p2, p1, v1, v0, p3}, Lcom/ghomesdk/gameplus/login/ui/FillRealInfoView;-><init>(ZZZLjava/lang/String;)V
    ...
    .line 530
    new-instance p2, Lcom/ghomesdk/gameplus/login/ui/ActivateView;

    invoke-virtual {v5, p1}, Ljava/lang/String;->equals(Ljava/lang/Object;)Z

    move-result p1

    invoke-direct {p2, p1}, Lcom/ghomesdk/gameplus/login/ui/ActivateView;-><init>(Z)V
    ...
    .line 532
    new-instance p1, Lcom/ghomesdk/gameplus/login/ui/SelectLoginModeView;

    invoke-direct {p1}, Lcom/ghomesdk/gameplus/login/ui/SelectLoginModeView;-><init>()V
    ...
    .line 538
    new-instance p3, Lcom/ghomesdk/gameplus/login/ui/GuestUpgradeView;

    invoke-direct {p3, p1, p2}, Lcom/ghomesdk/gameplus/login/ui/GuestUpgradeView;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 544
    new-instance p1, Lcom/ghomesdk/gameplus/login/ui/QuickLoginView;

    iget-object p2, p0, Lcom/ghomesdk/gameplus/login/LoginController;->activity:Landroid/app/Activity;

    invoke-static {p2}, Lcom/ghomesdk/gameplus/login/model/QuickLoginData;->getQuickLogin(Landroid/content/Context;)Lcom/ghomesdk/gameplus/impl/object/QuickLoginModel;

    move-result-object p2

    invoke-direct {p1, p2}, Lcom/ghomesdk/gameplus/login/ui/QuickLoginView;-><init>(Lcom/ghomesdk/gameplus/impl/object/QuickLoginModel;)V
    ...
    .line 546
    new-instance p1, Lcom/ghomesdk/gameplus/login/ui/BindPhoneView;
    ...
    invoke-direct {p1, p2, p3}, Lcom/ghomesdk/gameplus/login/ui/BindPhoneView;-><init>(Landroid/app/Activity;Ljava/lang/String;)V
    ...
    .line 548
    new-instance p1, Lcom/ghomesdk/gameplus/login/ui/FillRealBindPhoneInfoView;

    invoke-direct {p1, v0, v1}, Lcom/ghomesdk/gameplus/login/ui/FillRealBindPhoneInfoView;-><init>(ZZ)V
    ...
    iget-object p3, p0, Lcom/ghomesdk/gameplus/login/LoginController;->dlgLogin:Lcom/ghomesdk/gameplus/login/LoginDialog;

    invoke-virtual {p1, p2, p3}, Lcom/ghomesdk/gameplus/login/ui/LoginView;->init(Landroid/app/Activity;Lcom/ghomesdk/gameplus/login/LoginDialog;)V
